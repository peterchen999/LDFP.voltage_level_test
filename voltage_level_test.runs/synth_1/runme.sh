...
HD_PWD='D:/petersLDlab/FP/voltage_level_test/voltage_level_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voltage_level.vds -m64 -mode batch -messageDb vivado.pb -notrace -source voltage_level.tcl
