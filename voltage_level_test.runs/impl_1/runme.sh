...
HD_PWD='D:/petersLDlab/FP/voltage_level_test/voltage_level_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voltage_level.vdi -applog -m64 -messageDb vivado.pb -mode batch -source voltage_level.tcl -notrace
